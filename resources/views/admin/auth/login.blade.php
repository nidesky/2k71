        ...
        <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
            ...
            <div class="block block-themed animated fadeIn">
                ...
                <div class="block-content block-content-full block-content-narrow">
                    <!-- Login Title -->
                    <h1 class="h2 font-w600 push-30-t push-5">admin.2k71.com</h1>
                    ...
                    <form class="js-validation-login form-horizontal push-30-t push-50" action="{{ url('auth/login') }}" method="post">
...
<!-- Page JS Code -->
<script src="/admin/js/pages/base_pages_login.js"></script>
</body>
</html>